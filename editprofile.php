...
$sql="UPDATE profile  SET `dp`='$profileImageName' WHERE id='1';";
mysqli_query($db, $sql);
$sql="UPDATE profile  SET `bio`='$bio' WHERE id='1';";
mysqli_query($db, $sql);
...
<input type="file" name="dp" id="profileImage" style="display:none;">
   ...
   <div>
   <button type="submit" name="save-user" class="btn btn-warning btn-block">Save</button>
</div>
